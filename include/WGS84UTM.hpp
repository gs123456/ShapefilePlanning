...
//     utmX=422946.570688309;
//     utmY=4454762.859288738;
...
//     // 调用UTM坐标转换为经度和纬度的函数
//     coorconv::UTMXYToLatLon(utmCoord, zone, isSouthernHemi, wgsCoord);

//     // 显示结果
//     std::cout << "UTM X 坐标：" << std::fixed << std::setprecision(9) <<  utmX<< " 米" << std::endl;
//     std::cout << "UTM Y 坐标：" << std::fixed << std::setprecision(9) << utmY << " 米" << std::endl;
//     std::cout << "转换后的WGS84经度: " << std::fixed << std::setprecision(9) << coorconv::RadToDeg(wgsCoord.lon) << " 度" << std::endl;
//     std::cout << "转换后的WGS84纬度: " << std::fixed << std::setprecision(9)<< coorconv::RadToDeg(wgsCoord.lat) << " 度" << std::endl;
...
// int main() {
//     // 示例WGS84坐标（以经度和纬度表示）
//     double longitude = 116.094139099; // 以度为单位
//     double latitude = 40.239765167;   // 以度为单位
...
//     // 打印转换后的UTM坐标
//     std::cout << "WGS84经度：" << std::fixed << std::setprecision(9) << longitude << " 度" << std::endl;
//     std::cout << "WGS84纬度：" << std::fixed << std::setprecision(9) << latitude << " 度" << std::endl;
//     std::cout << "转换后的UTM X 坐标：" << std::fixed << std::setprecision(9) << utmCoord.x << " 米" << std::endl;
//     std::cout << "转换后的UTM Y 坐标：" << std::fixed << std::setprecision(9) << utmCoord.y << " 米" << std::endl;
